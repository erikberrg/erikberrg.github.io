...
export default function Header() {
    ...
    return (
        <div className="flex justify-between items-center sticky top-0 z-50 py-8 px-24">
            <p className="font-bold">Erik Berg</p>
            <header className="w-fit md:h-14 h-12 md:px-2 px-1 py-2 bg-zinc-200/25 backdrop-blur-sm border-zinc-300/30 border-[1px] rounded-3xl flex justify-center items-center">
